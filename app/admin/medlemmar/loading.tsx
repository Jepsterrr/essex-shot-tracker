function ListItemSkeleton() {
  return (
    <li className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-3 gap-3 bg-gray-600/30">
      <div className="flex-grow flex items-center gap-3 mb-2 sm:mb-0">
...
export default function LoadingAdminMembersPage() {
  return (
    <div className="max-w-4xl mx-auto bg-card-white text-gray-800 rounded-xl shadow-2xl border border-gray-200/10 animate-pulse">
