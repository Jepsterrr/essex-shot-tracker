          ...
          <div className="border border-gray-200 rounded-lg overflow-hidden">
            <ul className="divide-y divide-gray-200">
              {witnesses.map(witness => (
                <li key={witness.id} className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-3 gap-3 text-gray-100 bg-gray-600/30 hover:bg-gray-600/50">
                  ...
                  <div className="flex items-center justify-end space-x-2 flex-shrink-0">
                    {editingWitnessId === witness.id ? (
                      <>
                        <button onClick={() => handleSaveClick(witness.id)} className="bg-green-600 text-white text-xs font-bold py-1 px-3 rounded-md hover:bg-green-700">Spara</button>
                      ...
                      <>
                        <button onClick={() => handleEditClick(witness)} className="font-semibold text-xs py-1 px-3 rounded-md text-gray-200 hover:bg-gray-600">Redigera</button>
