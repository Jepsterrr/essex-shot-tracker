  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      <div className="max-w-md w-full bg-card-white text-gray-800 rounded-xl shadow-2xl p-8 border border-gray-200/10">
        <h1 className="text-3xl font-serif font-bold text-center mb-6 text-gray-200">Lösenordsskyddad</h1>
        <p className="text-center text-gray-300 mb-6">Ange lösenordet för att få tillgång till sidan.</p>
