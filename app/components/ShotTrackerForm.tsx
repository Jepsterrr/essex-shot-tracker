    ...
    <div className="max-w-3xl mx-auto pb-20">
      ...
      >
            ...
            {[3, 5, 10].map((val) => (
              <motion.button
                ...
                className={`flex-1 py-2 rounded-lg text-sm font-bold border transition-colors ${
                  isAddMode
                    ? "bg-red-900/20 text-red-200 border-red-800/30 hover:bg-red-800/50"
                    : "bg-green-900/20 text-green-200 border-green-800/30 hover:bg-green-800/50"
                }`}
              >
                {val} Shots
              </motion.button>
        ...
        <div>
          ...
          <details className="group mt-3 bg-gray-800/40 border border-gray-700/60 rounded-lg">
            <summary className="flex items-center justify-between cursor-pointer p-3 text-sm font-medium text-gray-400 select-none outline-none hover:text-gray-300 transition-colors">
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {[
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-gray-800 text-gray-300 border border-gray-600 rounded-full text-sm font-medium hover:bg-gray-700 hover:text-white hover:border-gray-400 transition-all active:scale-95 prevent-select"
                  >
                    {chip}
                  </button>
                ))}
