function SkeletonRow() {
    return (
        <tr className="block lg:table-row mb-4 lg:mb-0 lg:border-b lg:border-gray-200 animate-pulse">
            {/* Person */}
            ...
            <td className="flex justify-between items-center p-3 lg:table-cell lg:px-3 lg:py-4 lg:text-center">
                ...
                <div className="h-4 bg-gray-300 rounded w-8 ml-auto lg:mx-auto"></div>
            </td>
            {/* Anledning */}
            <td className="flex justify-between items-start p-3 lg:table-cell lg:px-3 lg:py-4">
                ...
                <div className="h-4 bg-gray-300 rounded w-32 ml-auto lg:ml-0"></div>
            </td>
            {/* Vittnen */}
            <td className="flex justify-between items-start p-3 lg:table-cell lg:px-3 lg:py-4">
                 <span className="font-bold lg:hidden mr-2 text-transparent">Vittnen</span>
                <div className="h-4 bg-gray-300 rounded w-28 ml-auto lg:ml-0"></div>
            </td>
            {/* Datum */}
            <td className="flex justify-between items-center p-3 lg:table-cell lg:py-4 lg:pl-3 lg:pr-4 lg:text-right sm:pr-6">
                ...
                <div className="h-4 bg-gray-300 rounded w-36 ml-auto lg:ml-0"></div>
            </td>
        </tr>
    );
}
